...
# Set param values
region= "us-east-1"
source_file_path= "s3://demo-test-data-ingestion-pipeline/landing-zone/"
target_file_path= "s3://demo-test-data-ingestion-pipeline/curated-zone/billionaire_rankings/"
glueCrawler_name= "glue-demo-data-crawler"
